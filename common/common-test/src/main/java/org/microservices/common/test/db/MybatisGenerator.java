package org.microservices.common.test.db;
...
public class MybatisGenerator {
    ...
    public static class Builder {
        protected MybatisGenerator mybatisGenerator;
        ...
        public Builder author(String author) {
            mybatisGenerator.setAuthor(author);
            return this;
        }
    ...
    public static class OutputConfig {
        ...
        public OutputConfig tables(String... tables) {
            builder.mybatisGenerator.setTables(tables);
            return this;
        }

        public OutputConfig moduleName(String moduleName) {
            builder.mybatisGenerator.setModuleName(moduleName);
            return this;
        }

        public OutputConfig outputDir(String outputDir) {
            builder.mybatisGenerator.setOutputDir(outputDir);
            return this;
        }

        public Builder and() {
            if (StringUtils.isEmpty(builder.mybatisGenerator.getOutputDir())) {
                builder.mybatisGenerator.setOutputDir(getDefaultOutputDir());
            }
            return builder;
        }
    ...
    public static class DBConfig {
        ...
        public DBConfig driverClassName(String driverClassName) {
            builder.mybatisGenerator.setDriverClassName(driverClassName);
            return this;
        }

        public DBConfig url(String url) {
            builder.mybatisGenerator.setUrl(url);
            return this;
        }

        public DBConfig username(String username) {
            builder.mybatisGenerator.setUsername(username);
            return this;
        }

        public DBConfig password(String password) {
            builder.mybatisGenerator.setPassword(password);
            return this;
        }
    ...
    public void execute() {
        ...
        fastAutoGenerator.globalConfig(builder -> builder
                ...
                .fileOverride()
                .disableOpenDir()
                .outputDir(String.format("%s%s%s", outputDir, File.separator, "java"))
                .dateType(DateType.TIME_PACK)
                .commentDate("HH:mm yyyy/MM/dd"));

        // 包配置
        fastAutoGenerator.packageConfig(builder -> builder
                .parent("org.microservices")
